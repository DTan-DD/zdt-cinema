...
const HeroSection = () => {
  ...
  return (
    ...
    bg-[url("./assets/backgroundImage.png")] bg-cover bg-center h-screen'
    >
      ...
      <button
        ...
        className="flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full
